...
/* TODO(donnie):  Cannot declare main() noreturn, as it is defined by the
 * C Standard to return.
int main (void) NO_RETURN;
 */

/* Pintos main program. */

// Initialize frame table and swap table are global
// Page table and mmap are thread specific
...
main (void)
{
  ...
  /* Finish up. */
  shutdown ();
  thread_exit (thread_current ()->status);
}
